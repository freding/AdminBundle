...
/**
 * Acme\DemoBundle\Entity\Test2
 *
 * @ORM\Table(name="TBL_test2")
 * @ORM\Entity
 * @CLASS_ROW\ManageByBo(user_name={"fr":"Test2 name","en":"Test2 en"},order=1,lang_class_namespace="\Acme\DemoBundle\Entity\Test2Lang",mother_node={"fr":"Parent","en":"Parent en"})
 */
class Test2 implements \Fredb\AdminBundle\Services\AdministrableEntity\AdministrableEntity, \Fredb\AdminBundle\Services\AdministrableEntity\SortableEntity {
	...
	/** @LINK_ROW\Liste(user_name={"fr":"lier entity test","en":"link entity test"},class_item_linked="Acme\DemoBundle\Entity\Test" ) */
	protected $link_test;  
