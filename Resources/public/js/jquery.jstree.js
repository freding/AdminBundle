	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree li { display:block; min-height:18px; line-height:18px; white-space:nowrap; margin-left:14px;} ' + 
				'.jstree-rtl li { margin-left:0; margin-right:18px; } ' + 
				'.jstree > ul > li { margin-left:0px;} ' + 
				'.jstree-rtl > ul > li { margin-right:0px; } ' + 
				'.jstree ins { display:inline-block; text-decoration:none; width:14px; height:18px; margin:0 0 0 0; padding:0; vertical-align:top; zoom:1; *display: inline; _height: 18px;} ' + 
				'.jstree a { display:inline-block; line-height:18px; color:black; white-space:nowrap; text-decoration:none; padding:0; margin:0; zoom:1; *display: inline; _height: 18px;} ' + 
				'.jstree a:focus { outline: none; } ' + 
				'.jstree a > ins { height:18px; width:12px; vertical-align:bottom; } ' + 
				'.jstree a > .jstree-icon { margin-right:0px; vertical-align:top} ' + 
				'.jstree-rtl a > .jstree-icon { margin-left:0px; margin-right:0; vertical-align:top} ' + 
		...
		if(/msie/.test(u) && parseInt(v, 10) == 6) { 
			...
			css_string += '' + 
				...
				'.jstree li a { display:inline; border-width:0 !important; padding:0 !important; } ' + 
				'.jstree li a ins { height:18px; width:12px; margin-right:0px; vertical-align:bottom} ' + 
				'.jstree-rtl li a ins { margin-right:0px; margin-left:0px; ; vertical-align:bottom} ';
		}
	...
	$.jstree.plugin("core", {
		...
		_fn : { 
			init	: function () { 
				...
				this.get_container()
					.delegate("li > ins, li > a.no-link, button", "click.jstree", $.proxy(function (event) {
							var trgt = $(event.target);
							if(trgt.is("ins, button, a") && event.pageY - trgt.offset().top < this.data.core.li_height) { this.toggle_node(trgt); }
						}, this))
			...
			open_node	: function (obj, callback, skip_animation) {
				...
				if(!this._is_loaded(obj)) {
					...
					if(obj.hasClass("root")){
						obj.removeClass("jstree-closed-root").addClass("jstree-open-root").children("a").removeClass("jstree-loading");
					}
					obj.removeClass("jstree-closed jstree-closed-root").addClass("jstree-open").children("a").removeClass("jstree-loading");
			...
			close_node	: function (obj, skip_animation) {
				...
				if(obj.hasClass("root")){
					obj.removeClass("jstree-open-root").addClass("jstree-closed-root");
				}
				obj.removeClass("jstree-open jstree-open-root").addClass("jstree-closed");
			...
			clean_node	: function (obj) {
				...
				obj.filter(".root").not(".jstree-open").addClass("jstree-closed-root");
			...
			delete_node : function (obj) {
				...
				if(p !== -1 && p.find("> ul > li").length === 0) {
					p.removeClass("jstree-open jstree-closed jstree-open-root jstree-closed-root").addClass("jstree-leaf");
				}
				this.clean_node(p);
			...
			move_node : function (obj, ref, position, is_copy, is_prepared, skip_check) {
				...
				try { 
					...
					if(!obj.op.find("> ul > li").length) {
						obj.op.removeClass("jstree-open jstree-closed jstree-open-root jstree-closed-root").addClass("jstree-leaf").children("ul").remove();
					}
				} catch (e) { }
					...
					case (!s.data && !!s.ajax) || (!!s.data && !!s.ajax && obj && obj !== -1):
						error_func = function (x, t, e) {
							...
							if(obj != -1 && obj.length) {
								...
								if(t === "success" && s.correct_state) { obj.removeClass("jstree-open jstree-closed jstree-open-root jstree-closed-root").addClass("jstree-leaf"); }
							}
							else {
						...
						success_func = function (d, t, x) {
							...
							if(d) {
								...
								if(obj === -1 || !obj) {
									...
									obj.data("jstree-is-loading",false);
									if(s.correct_state) { 
										obj.removeClass("jstree-open jstree-closed jstree-open-root jstree-closed-root").addClass("jstree-leaf"); 
										if(s_call) { s_call.call(this); } 
									}
								}
							}
					...
					case (!s.data && !s.ajax):
						if(!obj || obj == -1) {
							this.get_container()
								...
								.find("li").filter(function () { return this.firstChild.tagName !== "INS"; }).not(".no-icon").prepend("<ins class='jstree-icon'></ins>").end()
								.find("a.no-link").prepend("<ins class='jstree-icon'></ins>").end()
								.find("a.no-link div").prepend("<ins class='jstree-icon'></ins>").end()
								.filter("a").children("ins:first-child").not(".jstree-icon").addClass("jstree-icon");
							if(is_ie){
								this.get_container().find("li, a").filter(".no-icon").wrap("<button class='btnGeneric'>").parent().parent().after("<div class='first-sub-padding'></div>").end();
							} else {
								this.get_container().find("li, a").filter(".no-icon").wrap("<button class='btnGeneric'>").parent().after("<div class='first-sub-padding'></div>").end()
							}
							this.clean_node();
						}
						if(s_call) { s_call.call(this); }
